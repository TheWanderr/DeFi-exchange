...
import coboltBlu from '../assets/CoboltBlu.png';
...
const Balance = () => {
    ...
    return (
      <div className='component exchange__transfers'>
        ...
        {/* Deposit/Withdraw Component 1 (BLU) */}
  
        <div className='exchange__transfers--form'>
          <div className='flex-between'>
            <p><small>Token</small><br /><img src={coboltBlu} alt="Token logo" />{symbols && symbols[0]}</p>
        ...
        {/* Deposit/Withdraw Component 2 (mETH) or (cUSD) */}
