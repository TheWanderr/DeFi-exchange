...
const decorateOrder = (order, tokens) => {
  ...
  // Note: BLU should be considered token0, mETH is considered token1
  // Example: Giving mETH in exchange for BLU
  if (order.tokenGive === tokens[0].address) {
    token0Amount = order.amountGive // The amount of BLU we are giving
    token1Amount = order.amountGet // The amount of mETH we want...
  } else {
    token0Amount = order.amountGet // The amount of BLU we want
...
export const filledOrdersSelector = createSelector(filledOrders, tokens, (orders, tokens) => {
  ...
  //Sort orders by time decending for UI
...
export const priceChartSelector = createSelector(filledOrders, tokens, (orders, tokens) => {
  ...
  //Get last 2 orders fro final price & price change 
